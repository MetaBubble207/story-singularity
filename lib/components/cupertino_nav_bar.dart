...
Widget _wrapWithBackground(
  ...
  var r = math.min(shrinkOffset, 10.0);
  return ClipRect(
    child: BackdropFilter(
      filter: ImageFilter.blur(sigmaX: r, sigmaY: r),
...
/// to also has a [CupertinoNavigationBar2] or a [CupertinoSliverNavigationBar2]
...
///
/// By default, only one [CupertinoNavigationBar2] or [CupertinoSliverNavigationBar2]
...
///
/// {@tool dartpad}
/// This example shows a [CupertinoNavigationBar2] placed in a [CupertinoPageScaffold].
...
///  * [CupertinoSliverNavigationBar2] for a navigation bar to be placed in a
///    scrolling list and that supports iOS-11-style large titles.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/bars/navigation-bars/>
class CupertinoNavigationBar2 extends StatefulWidget
    implements ObstructingPreferredSizeWidget {
  /// Creates a navigation bar in the iOS style.
  const CupertinoNavigationBar2({
    super.key,
    this.leading,
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.leading}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.automaticallyImplyLeading}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.previousPageTitle}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.trailing}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.backgroundColor}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.brightness}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.padding}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.border}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.transitionBetweenRoutes}
  ...
  /// {@template flutter.cupertino.CupertinoNavigationBar2.heroTag}
  /// Tag for the navigation bar's Hero widget if [transitionBetweenRoutes] is true.
  ///
  /// Defaults to a common tag between all [CupertinoNavigationBar2] and
  /// [CupertinoSliverNavigationBar2] instances of the same [Navigator]. With the
  ...
  @override
  State<CupertinoNavigationBar2> createState() =>
      _CupertinoNavigationBar2State();
}
...
class _CupertinoNavigationBar2State extends State<CupertinoNavigationBar2> {
...
///
/// The [CupertinoSliverNavigationBar2] must be placed in a sliver group such
...
///
/// Like [CupertinoNavigationBar2], it also supports a [leading] and [trailing]
...
/// behavior for multiple navigation bars per route.
///
/// [CupertinoSliverNavigationBar2] has its text scale factor set to 1.0 by default
...
/// [CupertinoSliverNavigationBar2]'s components inside a [MediaQuery] with the
...
///
/// {@tool dartpad}
/// This example shows [CupertinoSliverNavigationBar2] in action inside a [CustomScrollView].
///
...
/// See also:
///
///  * [CupertinoNavigationBar2], an iOS navigation bar for use on non-scrolling
///    pages.
///  * [CustomScrollView], a ScrollView that creates custom scroll effects using slivers.
///  * <https://developer.apple.com/design/human-interface-guidelines/ios/bars/navigation-bars/>
class CupertinoSliverNavigationBar2 extends StatefulWidget {
  ...
  /// {@macro flutter.cupertino.CupertinoNavigationBar2.leading}
  ///
  /// This widget is visible in both collapsed and expanded states.
  final Widget? leading;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.automaticallyImplyLeading}
  final bool automaticallyImplyLeading;
  ...
  /// {@macro flutter.cupertino.CupertinoNavigationBar2.previousPageTitle}
  final String? previousPageTitle;
  ...
  /// {@macro flutter.cupertino.CupertinoNavigationBar2.trailing}
  ///
  /// This widget is visible in both collapsed and expanded states.
  final Widget? trailing;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.backgroundColor}
  final Color? backgroundColor;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.brightness}
  final Brightness? brightness;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.padding}
  final EdgeInsetsDirectional? padding;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.border}
  final Border? border;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.transitionBetweenRoutes}
  final bool transitionBetweenRoutes;

  /// {@macro flutter.cupertino.CupertinoNavigationBar2.heroTag}
  final Object heroTag;
  ...
  @override
  State<CupertinoSliverNavigationBar2> createState() =>
      _CupertinoSliverNavigationBar2State();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _CupertinoSliverNavigationBar2State
    extends State<CupertinoSliverNavigationBar2> {
  late _NavigationBarStaticComponentsKeys keys;
...
class _LargeTitleNavigationBarSliverDelegate
  ...
  Widget build(
    ...
    final bool showLargeTitle = shrinkOffset < 10;
    ...
    return Hero(
      ...
      // CupertinoSliverNavigationBar2 like CupertinoNavigationBar2 because it
...
class _PersistentNavigationBar extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    if (leading == null && backChevron != null && backLabel != null) {
      leading = CupertinoNavigationBar2BackButton._assemble(
        backChevron,
        backLabel,
      );
    }
...
// components that are used in common by the CupertinoNavigationBar2 and
// CupertinoSliverNavigationBar2. The KeyedSubtrees are inserted into static
...
/// A nav bar back button typically used in [CupertinoNavigationBar2].
///
/// This is automatically inserted into [CupertinoNavigationBar2] and
/// [CupertinoSliverNavigationBar2]'s `leading` slot when
/// `automaticallyImplyLeading` is true.
///
/// When manually inserted, the [CupertinoNavigationBar2BackButton] should only
...
class CupertinoNavigationBar2BackButton extends StatelessWidget {
  /// Construct a [CupertinoNavigationBar2BackButton] that can be used to pop
  /// the current route.
  ///
  /// The [color] parameter must not be null.
  const CupertinoNavigationBar2BackButton({
    super.key,
    this.color,
    this.previousPageTitle,
    this.onPressed,
  ...
  const CupertinoNavigationBar2BackButton._assemble(
    this._backChevron,
    this._backLabel,
  ...
  Widget build(BuildContext context) {
    ...
    if (onPressed == null) {
      assert(
        ...
        'CupertinoNavigationBar2BackButton should only be used in routes that can be popped',
      );
    }
